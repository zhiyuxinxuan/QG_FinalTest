...
cancel.onclick = function () {
    img.src = "http://img.tukuppt.com//png_preview/00/04/79/gCVIp0YiIY.jpg!/fw/780"
}
const checkboxes = document.querySelectorAll('.meeting_type')
const maxAllow = 3;
checkboxes.forEach(checkbox => {
    checkbox.addEventListener('change', () => {
        const checkCount = document.querySelectorAll('.meeting_type:checked').length;
        if (checkCount > maxAllow) {//超过后禁选
